# VAT-Safe Design Rules

## Status

Current design guardrail, not tax advice.
...
ApexCrest must be designed and marketed as a **premium illustrated collector-world book**.

It must not be designed or marketed as:

- an album
- a picture-card album
- a binder
- a card holder
- a storage book
- a display accessory
...
HMRC guidance treats picture-card and stamp albums as standard-rated where 25% or more of the album is set aside for the mounting of cards or stamps.

HMRC guidance also asks whether the text in the article has value in its own right or is merely incidental to the pictures, stamps, or samples.

ApexCrest must therefore be built to support the argument that:
...
Fixed pockets or flaps can create risk if they alter the primary function of the article.

The ApexCrest wallet/sleeve must therefore be treated as an integrated display feature inside a complete book, not as the reason the product exists.

The book must be judged on its own qualities without inserted cards.

## Mandatory design constraints

### Must do

- The product must be a hardback illustrated book.
...
- Do not use writing fields, memory lines, diary spaces, checklist boxes, or scrapbook features.
- Do not use prompts such as “write your memory here”.
- Do not rely on tick/shade circles in the first edition.
- Do not make the card slot the main feature of the whole chapter.
- Do not use “insert card here” as the main page purpose.
...
Every world must include meaningful authored text that can be read independently of the inserted card.

Avoid simple prompts only.

Good reading matter includes:

- world essays
- emotional landscape description
- collector philosophy
- atmosphere and meaning
- authored reflections on rarity, nostalgia, achievement, challenge, beauty, wonder, safety, and legacy
...
**If the card wallet were empty, would this still feel like a finished illustrated book chapter?**
...
Marketing must lead with the illustrated book, not the number of cards it can display.

## Final rule

ApexCrest is not a card album.
